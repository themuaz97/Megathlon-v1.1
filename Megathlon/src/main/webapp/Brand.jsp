            ...
            <body class="hold-transition sidebar-mini">
               ...
               with font-awesome or any other icon font library -->
                                    ...
                                    <li class="nav-item menu-open">
                                        <a href="#" class="nav-link active"> <i class="nav-icon fas fa-edit"></i>
                                            <p>
                                        ...
                                        <ul class="nav nav-treeview">
                                            <li class="nav-item">
                                            	<a href="ProductsList.jsp" class="nav-link active"> 
                                            		<i class="far fa-circle nav-icon"></i>
                                                    <p>Products</p>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                            	<a href="CreateProduct.jsp" class="nav-link"> 
                                            		<i class="far fa-circle nav-icon"></i>
                                                    <p>Add Product</p>
                                                </a>
                                            </li>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row mb-2 justify-content-end">
                                    <div class="col-sm-6 m">
                                        <button type="button" onClick="CreateProduct.jsp"
                                                        ...
                                                        <%ArrayList<Product> ProductList = (ArrayList<Product>)request.getAttribute("ProductList");
                                                                ...
                                                                for(int i = 0; i < ProductList.size(); ++i){%>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <%= ProductList.get(i).getSupplier() %>
                                                                        </td>
                                                                        <td>
                                                                            <button type="button"
                                                                                class="btn btn-primary btn-lg btn-block btn-sm">Edit</button>
                                                                            <button type="button"
                                                                                class="btn btn-danger btn-lg btn-block btn-sm">Delete</button>
                                                                        </td>
                                                                    </tr>
                    ...
                    <footer class="main-footer">
                        ...
                        <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">Megathlon</a>.
